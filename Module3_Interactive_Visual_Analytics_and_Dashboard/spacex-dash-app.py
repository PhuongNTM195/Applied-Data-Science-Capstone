...
launch_sites.append({'label': 'CCAFS LC-40', 'value': 'CCAFS LC-40'})
launch_sites.append({'label': 'VAFB SLC-4E', 'value': 'VAFB SLC-4E'})
launch_sites.append({'label': 'KSC LC-39A', 'value': 'KSC LC-39A'})
launch_sites.append({'label': 'CCAFS SLC-40', 'value': 'CCAFS SLC-40'})
...
def select(inputt):
    ...
    if inputt == 'All Sites':
        ...
        new_df = (
            spacex_df[spacex_df["Launch Site"] == inputt]
            ['class']
            .value_counts()
            .reset_index()
        )
        ...
        new_df['Result'] = new_df['class'].map({
            0: 'Failure',
            1: 'Success'
        })
